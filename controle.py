...
painel_de_criacao = ft.AlertDialog(
    ...
    actions=[
        ft.Row(
            [
                ft.Checkbox(label="", on_change=lambda e: print("VOU DEIXAR O OCO"),fill_color=ft.Colors.GREEN,shape= ft.CircleBorder()),
        ...
        ft.Row(
            ...
            # programar a função criar
                ft.TextButton(
                    ...
                    on_click=lambda e: print(componentes['cor_teste'].current.value)
                ),
                ft.TextButton(
                    "cancelar",
                    style = ft.ButtonStyle(bgcolor = ft.Colors.BLACK38),
