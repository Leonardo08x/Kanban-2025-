import tela_cadastro, tela_tabela, tela_teste
import flet as ft
...
def desabilita_botão_criar(e):
    cores = []
    nome_do_Kanbam : str = nome_kamb.value
                                ...
                                [
                                    ...
                                    ft.Column(
                                        ...
                                        controls=[
                                            ft.Row(
                                               scroll=ft.ScrollMode.ALWAYS,
                                               controls=recuperar_colunas(limite, cores)
                                            ) # Row
                                        ]
                                    ) # Column
                                ]
...
painel_de_criacao2 = ft.AlertDialog(
    ...
    actions_alignment=ft.MainAxisAlignment.END,
    on_dismiss=lambda e: page.add(ft.Text("reali é gay"))
)
