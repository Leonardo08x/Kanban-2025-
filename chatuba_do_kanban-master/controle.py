...
green = ft.Checkbox(
    label="",
    on_change=lambda e: print("VOU DEIXAR O OCO Verde"),
...
red = ft.Checkbox(
    label="",
    on_change=lambda e: print("VOU DEIXAR O OCO Vermelho"),
...
yellow = ft.Checkbox(
    label="",
    on_change=lambda e: print("VOU DEIXAR O OCO Amarelo"),
...
orange = ft.Checkbox(
    label="",
    on_change=lambda e: print("VOU DEIXAR O OCO Laranja"),
